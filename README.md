...
spec:
  java:
    ...
    image: ghcr.io/vmaleze/opentelemetry-java-ignore-spans:1.27.0
```

## Current versions
* Extension version => [1.27.0](https://github.com/vmaleze/opentelemetry-java-ignore-spans/releases)
